...
public class InvalidLoginFunctionality {
	WebDriver driver;

	public InvalidLoginFunctionality(WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void url3() throws InterruptedException
	{
		driver.get("https://magento.softwaretestingboard.com/customer/account/login/referer/aHR0cHM6Ly9tYWdlbnRvLnNvZnR3YXJldGVzdGluZ2JvYXJkLmNvbS8%2C/");
		Thread.sleep(2000);
	}
	
	public void logintest(String e,String p) throws InterruptedException
	{
	...
	public void clickbutton() throws InterruptedException
	{
		...
		if(expurl.equals(accurl))
		{
			...
			System.out.println(" A guest cannot purchase product with out registration");
		}
	}
