...
public class RelevantProductDisplay {
	WebDriver driver;

	public RelevantProductDisplay (WebDriver driver)
	{
		this.driver=driver;
	}
	...
	public void searchcheck() throws InterruptedException
	{
		...
		WebElement womenTab=driver.findElement(By.xpath("//*[@id=\"ui-id-4\"]"));
		WebElement topTab=driver.findElement(By.xpath("//*[@id=\"ui-id-9\"]"));
		WebElement jacketTab=driver.findElement(By.xpath("//*[@id=\"ui-id-11\"]"));
		actions.moveToElement(womenTab).moveToElement(topTab).moveToElement(jacketTab).click().perform();
